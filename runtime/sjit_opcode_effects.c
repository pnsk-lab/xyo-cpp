...
const char *sjit_expr_opcode_name(int opcode) {
    ...
    case SJIT_EXPR_SIZE: return "size";
    case SJIT_EXPR_BACKDROP_NUMBER_NAME: return "backdrop-number-name";
    case SJIT_EXPR_LIST_CONTENTS: return "list-contents";
    case SJIT_EXPR_TOUCHING_OBJECT: return "touching-object";
    case SJIT_EXPR_TOUCHING_COLOR: return "touching-color";
    case SJIT_EXPR_COLOR_TOUCHING_COLOR: return "color-touching-color";
    case SJIT_EXPR_DISTANCE_TO: return "distance-to";
    case SJIT_EXPR_SENSING_OF: return "sensing-of";
    case SJIT_EXPR_CURRENT: return "current";
    case SJIT_EXPR_ANSWER: return "answer";
    case SJIT_EXPR_LOUDNESS: return "loudness";
    case SJIT_EXPR_LOUD: return "loud";
    case SJIT_EXPR_ONLINE: return "online";
    case SJIT_EXPR_USERNAME: return "username";
    case SJIT_EXPR_SOUND_VOLUME: return "sound-volume";
    case SJIT_EXPR_COUNTER: return "counter";
...
const char *sjit_statement_opcode_name(int opcode) {
    ...
    case SJIT_STMT_MOTION_MOVE_STEPS: return "move-steps";
    case SJIT_STMT_MOTION_GOTO: return "go-to";
    case SJIT_STMT_MOTION_TURN_RIGHT: return "turn-right";
    case SJIT_STMT_MOTION_TURN_LEFT: return "turn-left";
    case SJIT_STMT_MOTION_POINT_DIRECTION: return "point-direction";
    case SJIT_STMT_MOTION_POINT_TOWARDS: return "point-towards";
    case SJIT_STMT_MOTION_GLIDE_XY: return "glide-to-xy";
    case SJIT_STMT_MOTION_GLIDE_TO: return "glide-to";
    case SJIT_STMT_MOTION_IF_ON_EDGE_BOUNCE: return "if-on-edge-bounce";
    case SJIT_STMT_MOTION_SET_ROTATION_STYLE: return "set-rotation-style";
    case SJIT_STMT_LOOKS_THINK: return "think";
    case SJIT_STMT_LOOKS_THINK_FOR_SECS: return "think-for-seconds";
    case SJIT_STMT_LOOKS_SWITCH_BACKDROP_AND_WAIT: return "switch-backdrop-and-wait";
    case SJIT_STMT_LOOKS_NEXT_COSTUME: return "next-costume";
    case SJIT_STMT_LOOKS_NEXT_BACKDROP: return "next-backdrop";
    case SJIT_STMT_LOOKS_CHANGE_SIZE: return "change-size";
    case SJIT_STMT_LOOKS_HIDE_ALL_SPRITES: return "hide-all-sprites";
    case SJIT_STMT_LOOKS_GO_FORWARD_BACKWARD_LAYERS: return "change-layer";
    case SJIT_STMT_LOOKS_CHANGE_STRETCH: return "change-stretch";
    case SJIT_STMT_LOOKS_SET_STRETCH: return "set-stretch";
    case SJIT_STMT_CREATE_CLONE: return "create-clone";
    case SJIT_STMT_DELETE_CLONE: return "delete-clone";
    case SJIT_STMT_CONTROL_GET_COUNTER: return "get-counter";
    case SJIT_STMT_CONTROL_INCR_COUNTER: return "increment-counter";
    case SJIT_STMT_CONTROL_CLEAR_COUNTER: return "clear-counter";
    case SJIT_STMT_CONTROL_ALL_AT_ONCE: return "all-at-once";
    case SJIT_STMT_SENSING_ASK_AND_WAIT: return "ask-and-wait";
    case SJIT_STMT_SOUND_PLAY: return "play-sound";
    case SJIT_STMT_SOUND_PLAY_UNTIL_DONE: return "play-sound-until-done";
    case SJIT_STMT_SOUND_STOP_ALL: return "stop-all-sounds";
    case SJIT_STMT_SOUND_SET_EFFECT: return "set-sound-effect";
    case SJIT_STMT_SOUND_CHANGE_EFFECT: return "change-sound-effect";
    case SJIT_STMT_SOUND_CLEAR_EFFECTS: return "clear-sound-effects";
    case SJIT_STMT_SOUND_SET_VOLUME: return "set-volume";
    case SJIT_STMT_SOUND_CHANGE_VOLUME: return "change-volume";
    case SJIT_STMT_STOP_OTHER_SCRIPTS_IN_STAGE: return "stop-other-scripts-in-stage";
    case SJIT_STMT_PEN_SET_COLOR_PARAM: return "pen-set-color-param";
    case SJIT_STMT_PEN_CHANGE_SIZE: return "pen-change-size";
    case SJIT_STMT_PEN_SET_SHADE: return "pen-set-shade";
    case SJIT_STMT_PEN_CHANGE_SHADE: return "pen-change-shade";
    case SJIT_STMT_PEN_SET_HUE: return "pen-set-hue";
    case SJIT_STMT_PEN_CHANGE_HUE: return "pen-change-hue";
